execute store result storage mchess:chesstools square.file int 1 run scoreboard players set .chesstools.square.file mchess 1
...
execute if score .chesstools.square.rank mchess matches 1.. run return run function mchess:chesstools/notation/fen/parse_rank_recursive