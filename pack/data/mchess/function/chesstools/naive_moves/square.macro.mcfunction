...
execute unless score .chesstools.square.file mchess matches 1..8 run return fail
execute unless score .chesstools.square.rank mchess matches 1..8 run return fail
