...
execute store result storage mchess:chesstools square.file int 1 run scoreboard players operation .chesstools.square.file mchess += .chesstools.delta.file mchess
execute store result storage mchess:chesstools square.rank int 1 run scoreboard players operation .chesstools.square.rank mchess += .chesstools.delta.rank mchess
